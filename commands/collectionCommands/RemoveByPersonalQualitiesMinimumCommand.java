 ...
 */
public class RemoveByPersonalQualitiesMinimumCommand implements Command {
    /**
    ...
    public void execute(String argument) {
        try {
            ...
            System.out.println("Удалён элемент по personalQualitiesMinimum: " + personalQualitiesMinimum);
        }catch (NumberFormatException e){
            System.out.println("Команде необходим аргумент типа float!");
        }
    }
